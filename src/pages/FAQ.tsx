    ...
    faqs: [
      {
        ...
        answer: "We offer comprehensive exterior property care including window cleaning (exterior and interior), pressure washing (siding, decks, patios, driveways), roof washing, gutter cleaning, seasonal snow removal, and property check-in services with photo/video documentation.",
      },
      {
